...
VALUES 
(1,'2001-03-03','Lara Nascimento','+55 81 1457-1005','beatriz16@gmail.com','1993-09-13','Esplanada de da Rosa','Conjunto Serra Verde','Mato Grosso do Sul','Mato Grosso','GO','Carnavalesco',1200.00, 'Diana'),
(2,'2004-03-22','Nicolas Souza','41 2670 6492','thiago52@hotmail.com','2016-06-01','Praça de Cardoso, 68','Maria Helena','Ceará','Santa Catarina','AL','Tecnólogo em irrigação e drenagem', 1850.23, 'Diana'),
...
ADD COLUMN nome_da_amada varchar(30);

select * from funcionarios;

CREATE TABLE funcionariosBkpCompleto (
...
ALTER TABLE funcionariosBkpCompleto
...
FOR EACH ROW
BEGIN
  INSERT INTO funcionariosBkpCompleto (
    data_modificacao, id, data_atualizacao, nome, telefone, email, data_nascimento,
    rua, bairro, cidade, estado, estado_sigla, cargo, salario, nome_da_amada
  )
  VALUES (
    NOW(), OLD.id, OLD.data_atualizacao, OLD.nome, OLD.telefone, OLD.email, OLD.data_nascimento,
    OLD.rua, OLD.bairro, OLD.cidade, OLD.estado, OLD.estado_sigla, OLD.cargo, OLD.salario, OLD.nome_da_amada
  );
END
$
...
UPDATE funcionarios SET nome_da_amada = 'bianca' WHERE id = 5;